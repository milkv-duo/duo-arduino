...
{
    extern const csi_pinmap_t csi_gpio_pinmap[];
    return target_pin_to_devidx(pin_name, csi_gpio_pinmap);
}
...
{
    extern const csi_pinmap_t csi_gpio_pinmap[];
    return target_pin_to_channel(pin_name, csi_gpio_pinmap);
}
...
{
    extern const csi_pinmap_t csi_gpio_pinmap[];
    return target_gpio_to_pin(gpio_idx,channel,csi_gpio_pinmap);
}

__ALWAYS_STATIC_INLINE uint32_t csi_pin_get_gpio_pinnum(pin_name_t pin_name)
{
    extern const csi_pinmap_t csi_gpio_pinmap[];
    return csi_pin_to_channel(pin_name, csi_gpio_pinmap);
}
...
const dev_pin_map_t* target_pin_number_to_dev(uint8_t pin, const  dev_pin_map_t *pinmap,
                                              uint8_t idx);
