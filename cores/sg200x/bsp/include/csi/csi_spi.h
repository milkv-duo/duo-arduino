...
// csi_error_t csi_spi_send_receive_dma(csi_spi_t *spi, const void *data_out, void *data_in, uint32_t size);
// csi_error_t csi_spi_send_dma(csi_spi_t *spi, const void *data, uint32_t size);
